...
<head>
	<meta charset="UTF-8">
	<title>Variepizzas - Administrador - Usuarios</title>
				 ...
				 <div class="eliminarPizza-tabla">
					<table>
				        <thead>
						 ...
						 <?php 
							require_once ("inc/class/sistema_class.php");

							$pizza = new Sistema();
							$pizza->obtenerUsuariosAdmin();

						 ?>
						<tr>
							<td colspan="7">
								<a href='agregarUsuarioAdmin.php' class='btn btn-success'>Agregar</a>
							</td>
						</tr>
